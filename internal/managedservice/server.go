...
func (s *Server) routes() http.Handler {
	...
	mux.HandleFunc("/v1/admin/users/search", s.withUserAuth(s.handleAdminUserSearch))
	mux.HandleFunc("/v1/admin/users/", s.withUserAuth(s.handleAdminUserByID))
	mux.HandleFunc("/v1/admin/credits", s.withUserAuth(s.handleAdminCredits))
